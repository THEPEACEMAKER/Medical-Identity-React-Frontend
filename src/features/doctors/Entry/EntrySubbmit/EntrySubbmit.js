...
const EntrySubmit = () => {
  ...
  const handleSubmit = (values, { setSubmitting, resetForm }) => {
    ...
    data.append("comment", medicalDiagnosis);
    data.append("prescription", prescription);
    data.append("code", code);
    data.append("analysis_image", profileImgUrl);

    api
      .post(
        `/medical-entry/doctor/create/patient/${patientId}/appointment/${appointmentId}/`,
        data,
        {
          headers: {
  ...
  const handelEntryUpdate = (values, { setSubmitting, resetForm }) => {
    ...
    api
      .put(
        `/medical-entry/doctor/update/${medical_entry_id}/patient/${patientId}/appointment/${appointmentId}/`,
        data,
        {
          headers: {
            "Content-Type": "multipart/form-data",
    ...
    <>
      ...
      {newEntry ? (
        ...
        <>
          ...
          <MDBBtn onClick={toggleShowPatient}>View</MDBBtn>
        </>
      )}
